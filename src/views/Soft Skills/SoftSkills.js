...
export const SoftSkills = () => {
  ...
  const handleChangeOnCheckbox = (e) => {
	...
	if (checked) {
	  setSkills({
		...skills,softSkills: [...skills.softSkills, value]});
	}
      ...
      <section className={module.formContainer}>
        ...
        <section className={module.checkboxText}>
          <input type="checkbox" name="softSkills" value="Communication" onClick={handleChangeOnCheckbox}/>
			...
			<input type="checkbox" name="softSkills" value="Teamwork" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Teamwork
  				<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Problem-solving" onClick={handleChangeOnCheckbox}/>
	  		<label class={module.checkbox}>Problem-solving
	  			<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Time managment" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Time managment
				<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Critical thinking" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Critical thinking
				<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Decision-making" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Decision-making
				<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Organizational" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Organizational
				<span class="checkmark"></span>
	  		</label><br />

			<input type="checkbox" name="softSkills" value="Stress managment" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Stress managment
			  <span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Other..." onClick={handleChangeOnCheckbox}/>
			...
			<input type="checkbox" name="softSkills" value="Adaptability" onClick={handleChangeOnCheckbox}/>
		  	<label class={module.checkbox}>Adaptability
		  		<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Conflict Managment" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Conflict Managment
				<span class="checkmark"></span>
	  		</label><br />

			  <input type="checkbox" name="softSkills" value="Leadership" onClick={handleChangeOnCheckbox} />
	  		<label class={module.checkbox}>Leadership
	  			<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Creativity" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Creativity
				<span class="checkmark"></span>
  			</label><br />

			<input type="checkbox" name="softSkills" value="Resourcefulness" onClick={handleChangeOnCheckbox}/>
  			<label class={module.checkbox}>Resourcefulness
  				<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Persuasion" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Persuasion
				<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Openness to criticism" onClick={handleChangeOnCheckbox}/>
			<label class={module.checkbox}>Openness to criticism
				<span class="checkmark"></span>
			</label><br />

			<input type="checkbox" name="softSkills" value="Open minded" onClick={handleChangeOnCheckbox} />
