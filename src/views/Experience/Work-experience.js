  ...
  return (
    ...
    <section className={module.formContainer}>
        ...
        <form className={module.formWork}>
            ...
            <select className={module.selector} onChange={handleChange} name='startYear'>
            ...
            <select className={module.selector} onChange={handleChange} name='endYear'>
            ...
            <label>Job Tittle<br/>
            <input onChange={handleChange} name='jobTittle' type="text" placeholder="e.g. Front End Engineer" className={module.formInput}/>
            </label>
            ...
            <div className={module.checkboxTech}>
                {technologies.map(technology=>{
                    return(
                        ...
                        <input selected value={technology} onChange={handleChangeOnCheckbox} name='stack' type="checkbox"/><span>{technology}</span>
                        </label>
                        )
                })}
            </div><br/>
